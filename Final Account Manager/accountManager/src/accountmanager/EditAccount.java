...
//**STAGE**********************************************************************    
    public Scene openScene(Stage stage, String fileName, String masterPass, Account a,int target) 
    {
        ...
        descTextField.setWrapText(true);
        ...
        genPassBtn.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event)
            {
                ...
                genPress.setText("Password Generated");
            }
        });
        ...
        submit.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event)
            {
                ...
                else
                {
                    ...
                    {
                        Logger.getLogger(EditAccount.class.getName()).log(Level.SEVERE, null, ne);
                    }
                    catch(NoSuchPaddingException p)
                    {
                        Logger.getLogger(EditAccount.class.getName()).log(Level.SEVERE, null, p);
                    }
                    catch(InvalidKeyException i)
                    {
                        Logger.getLogger(EditAccount.class.getName()).log(Level.SEVERE, null, i);
                    }
                    catch(IllegalBlockSizeException ib)
                    {
                        Logger.getLogger(EditAccount.class.getName()).log(Level.SEVERE, null, ib);
                    }
                    catch(BadPaddingException bp)
                    {
                        Logger.getLogger(EditAccount.class.getName()).log(Level.SEVERE, null, bp);
                    }
                    writer.print(json);
