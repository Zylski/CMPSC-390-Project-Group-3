        ...
        submit.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event)
            {
                ...
                if(rb1.isSelected())
                {
                    ...
                    {
                         Logger.getLogger(DeleteAccount.class.getName()).log(Level.SEVERE, null, ne);
                    }
                    catch (NoSuchPaddingException p)
                    {
                        Logger.getLogger(DeleteAccount.class.getName()).log(Level.SEVERE, null, p);
                    }
                    catch (InvalidKeyException i)
                    {
                        Logger.getLogger(DeleteAccount.class.getName()).log(Level.SEVERE, null, i);
                    }
                    catch (IllegalBlockSizeException ib)
                    {
                        Logger.getLogger(DeleteAccount.class.getName()).log(Level.SEVERE, null, ib);
                    }
                    catch (BadPaddingException bp)
                    {
                        Logger.getLogger(DeleteAccount.class.getName()).log(Level.SEVERE, null, bp);
                    }
                    writer.print(json);
