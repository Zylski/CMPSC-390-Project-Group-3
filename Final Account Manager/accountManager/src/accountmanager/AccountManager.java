...
/*------------------------------------------------------------------------------------
 *Programmer: Damian Zylski and Barry Hoinacki Jr
 ...
 *
 * A lot of this code was repeated and copy and pasted. In a future edit I might try to 
 * break it into methods to cut down on the lines of code
 * -----------------------------------------------------------------------------------
 */
        ...
        addSec.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event)
            {
                if (!currentDB.isEmpty() && !accountList.isEmpty())
                {
                    ...
                    //clear the security grid pane
                    secGrid.getChildren().clear();
                    ...
                    for (i = 0; i < size; i++)
                    {
                        ...
                        HBox secBtn = new HBox(10);
                        secBtn.setAlignment(Pos.BOTTOM_LEFT);
                        secBtn.getChildren().add(secReveal);
                        //secGrid.add(secReveal, 0, ++row);
                        //Button to edit security question
                        Button secEdit = new Button("Edit Question");
                        accountList.get(target).getSecurityQuestion().get(i).getAnswer();
                        Account aEdit = accountList.get(target);
                        SecurityQuestion sqEdit = accountList.get(target).getSecurityQuestion().get(i);
                        int editTarget = target;
                        int editI = i;
                        secEdit.setOnAction(new EventHandler<ActionEvent>()
                        {
                            @Override
                            public void handle(ActionEvent event)
                            {
                                ...
                                stage.setScene(edit.openScene(stage, currentDB, masterPassword, aEdit, editTarget, sqEdit, editI));
                                stage.showAndWait();
                            }
                        });
                        secBtn.getChildren().add(secEdit);
                        //secGrid.add(secEdit, 0, ++row);

                        //Button to delete security question
                        Button secDelete = new Button("Delete Question");
                        accountList.get(target).getSecurityQuestion().get(i).getAnswer();
                        Account aDelete = accountList.get(target);
                        SecurityQuestion sqDelete = accountList.get(target).getSecurityQuestion().get(i);
                        int deleteTarget = target;
                        int deleteI = i;
                        secDelete.setOnAction(new EventHandler<ActionEvent>()
                        {
                            @Override
                            public void handle(ActionEvent event)
                            {
                                ...
                                stage.setScene(delete.openScene(stage, currentDB, masterPassword, aDelete, deleteTarget, sqDelete, deleteI));
                                stage.showAndWait();
                            }
                        });
                        secBtn.getChildren().add(secDelete);
                        secGrid.add(secBtn, 0, ++row);

                        //advance rows
                        row = row + 5;
                        
                        //Answer context menu?
                        ContextMenu cmSec = new ContextMenu();
                        MenuItem mi1Sec = new MenuItem("Copy question answer to Clipboard");
                        cmSec.getItems().add(mi1Sec);
                        String text = accountList.get(target).getSecurityQuestion().get(i).getAnswer();
                        mi1Sec.setOnAction(new EventHandler<ActionEvent>()
                        {
                            public void handle(ActionEvent e)
                            {
                                if (!currentDB.isEmpty() && !accountList.isEmpty())
                                ...
                                else
                                {
                                    ...
                                    stage.showAndWait();
                                    securityStatusBar.setText("Error: Answer not Copied");
                                }
                            }
                        });

                        MenuItem mi2Sec = new MenuItem("Cancel");
                        cmSec.getItems().add(mi2Sec);
                        mi2Sec.setOnAction(new EventHandler<ActionEvent>()
                        {
                            public void handle(ActionEvent e)
                            {
                                System.out.println("no");
                        ...
                        secField.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>()
                        {
                            ...
                            public void handle(MouseEvent t)
                            {
                                if (t.getButton() == MouseButton.SECONDARY)
                                {
                                    cmSec.show(secField, t.getScreenX(), t.getScreenY());
                                }
                            }
                        });
                        secField.setContextMenu(cmSec);
                    }
                }
                //otherwise open an error page
                else
...
//******refresh Security Question Button***************************************************************************************************************
        Button refreshSec = new Button();
        refreshSec.setText("Refresh");
        refreshSec.setOnAction(new EventHandler<ActionEvent>()
        {
            @Override
            public void handle(ActionEvent event)
            {
        ...
        secToolBar.getItems().addAll(addSec,refreshSec);
//@@@@@@FOR PROPERTIES TAB@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//******property tab display controls***************************************************************************************************************
        ...
        Text propTitle = new Text("  Properties");
        Text tipP = new Text(" Select an \n account from \n the table \n on the \n account tab \n to add \n properties\n to it\n\n\n\n"
                + " After editing \n or deleting \n a property, \n press \n the refresh \n button to \n show the \n changes. ");
        tipP.setFont(Font.font("Courier New", FontWeight.BOLD, 13)); //a tip to be on the right?
        propTitle.setFont(Font.font("Courier New", FontWeight.BOLD, 20));
        propGrid.add(secTitle, 0, 0, 2, 1); //Not visible?
        ...
        addProp.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event)
            {
                if (!currentDB.isEmpty() && !accountList.isEmpty())
                {
                    ...
                    for (i = 0; i < accountList.size(); i++)
                    {
                        if (accountList.get(i).getLabel().compareTo(a.getLabel()) == 0)
                        {
                            ...
                            stage.setScene(addP.openScene(stage, currentDB, masterPassword, a, target));
                            stage.showAndWait();
                            break;
                        }
                        else
                    ...
                    int row = 1; //current row
                    int size = accountList.get(target).getAdditionalProperties().size();

                    //clear the properties grid pane
                    propGrid.getChildren().clear();

                    //List Properties for given account
                    for (i = 0; i < size; i++)
                    {
                        //text area for displaying properties
                        Text pLabel = new Text("Property " + (i + 1));
                        TextArea propArea = new TextArea();
                        propArea.setEditable(false);
                        propArea.wrapTextProperty().set(true);
                        propArea.setWrapText(true);
                        propArea.setPrefHeight(50);

                        //text field for display 
                        Text pvLabel = new Text("Value");
                        TextField propField = new TextField();
                        propField.setEditable(false);

                        //set property field
                        propArea.setText(accountList.get(target).getAdditionalProperties().get(i).getProperty());
                        propGrid.add(pLabel, 0, row);
                        propGrid.add(propArea, 0, ++row);

                        //set value field
                        String value = accountList.get(target).getAdditionalProperties().get(i).getPropertyAnswer();
                        propField.setText(value);
                        propGrid.add(pvLabel, 0, ++row);
                        propGrid.add(propField, 0, ++row);

                        //Button to edit properties
                        Button propEdit = new Button("Edit Property");
                        accountList.get(target).getAdditionalProperties().get(i).getPropertyAnswer();
                        Account aEdit = accountList.get(target);
                        AdditionalProperties apEdit = accountList.get(target).getAdditionalProperties().get(i);
                        int editTarget = target;
                        int editI = i;
                        propEdit.setOnAction(new EventHandler<ActionEvent>()
                        {
                            @Override
                            public void handle(ActionEvent event)
                            {
                                ...
                                stage.setScene(edit.openScene(stage, currentDB, masterPassword, aEdit, editTarget, apEdit, editI));
                                stage.showAndWait();
                            }
                        });
                        HBox propBtn = new HBox(10);
                        propBtn.setAlignment(Pos.BOTTOM_LEFT);
                        propBtn.getChildren().add(propEdit);
                        //propGrid.add(propEdit, 0, ++row);

                        //Button to delete properties
                        Button propDelete = new Button("Delete Property");
                        accountList.get(target).getAdditionalProperties().get(i).getPropertyAnswer();
                        Account aDelete = accountList.get(target);
                        AdditionalProperties apDelete = accountList.get(target).getAdditionalProperties().get(i);
                        int deleteTarget = target;
                        int deleteI = i;
                        propDelete.setOnAction(new EventHandler<ActionEvent>()
                        {
                            @Override
                            public void handle(ActionEvent event)
                            {
                                ...
                                stage.setScene(delete.openScene(stage, currentDB, masterPassword, aDelete, deleteTarget, apDelete, deleteI));
                                stage.showAndWait();
                            }
                        });
                        propBtn.getChildren().add(propDelete);
                        propGrid.add(propBtn, 0, ++row);
                ...
                else
                {
                    ...
                    stage.setScene(error.openScene(stage));
                    stage.showAndWait();
                    propertiesStatusBar.setText("Properties not added");
                }
            }
        });
//******Refresh Properties Button***************************************************************************************************************
        Button refreshProp = new Button();
        refreshProp.setText("Refresh");
        refreshProp.setOnAction(new EventHandler<ActionEvent>()
        {
            @Override
            public void handle(ActionEvent event)
            {
        ...
        //add buttons to tool bar
        propToolBar.getItems().addAll(addProp, refreshProp);
...
//!!!!!!SCENE SETUP!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!        
        ...
        //set the tool bar and title to a vbox
        VBox propTop = new VBox();
        propTop.getChildren().addAll(propToolBar,propTitle);
        
        //build the Properties tab by setting borderpane areas
        propertiesTab.setTop(propTop);
        propertiesTab.setRight(tipP);
...
//***** Security Tab select action****************************************************************************************************************************               
                if (newTab == tab2 && !currentDB.isEmpty() && !accountList.isEmpty())
                {
                    int i = 0;
                    int target = 0;
                    Account a = table.getFocusModel().getFocusedItem();
                    ...
                    for (i = 0; i < size; i++)
                    {
                        ...
                        hbBtn.getChildren().add(secReveal);
                        //secGrid.add(secReveal, 0, ++row);
                        //Button to edit security question
                        Button secEdit = new Button("Edit Question");                      
                        accountList.get(target).getSecurityQuestion().get(i).getAnswer();
                        ...
                        //secGrid.add(secDelete, 0, ++row);
                        hbBtn.getChildren().add(secDelete);
                        secGrid.add(hbBtn,0,++row);
                        //advance rows
                        row = row + 5;
                        
                        setSecStatusBar("Questions Loaded");
...
//***** Property Tab select action****************************************************************************************************************************                
                else if(newTab == tab3 && !currentDB.isEmpty() && !accountList.isEmpty())
                {
                    int i = 0;
                    int target = 0;
                    Account a = table.getFocusModel().getFocusedItem();
                    ...
                    for (i = 0; i < size; i++)
                    {
                        ...
                        //advance rows
                        row = row + 5;
                        setPropStatusBar("Properties Loaded");
                    }
...
//******ACCOUNT MANAGER METHODS*****************************************************************************************************
    ...
    //use this to give the Security status bar a massage
    public void setSecStatusBar(String s)
    {
        this.securityStatusBar.setText(s);
    }
    
    //use this to give the property status bar a massage
    public void setPropStatusBar(String s)
    {
        this.propertiesStatusBar.setText(s);
    }
    ...
    //use this to add Properties
    public void addProperty(AdditionalProperties ap, int target)
    {
        this.accountList.get(target).getAdditionalProperties().add(ap);
    }
    
    //use this to edit Security Questions
    public void editQuestion(SecurityQuestion sq, int aTarget, int sqTarget)
    {
        this.accountList.get(aTarget).getSecurityQuestion().get(sqTarget).setQuestion(sq.getQuestion());
        this.accountList.get(aTarget).getSecurityQuestion().get(sqTarget).setAnswer(sq.getAnswer());
    }
    
    //use this to edit properties
    public void editProperty(AdditionalProperties ap, int aTarget, int apTarget)
    {
        this.accountList.get(aTarget).getAdditionalProperties().get(apTarget).setProperty(ap.getProperty());
        this.accountList.get(aTarget).getAdditionalProperties().get(apTarget).setPropertyAnswer(ap.getPropertyAnswer());
    }
    
    //use this to delete Security Questions
    public void deleteQuestion(int aTarget, int sqTarget)
    {
        this.accountList.get(aTarget).getSecurityQuestion().remove(sqTarget);
        
    }
    
    //use this to delete properties
    public void deleteProperty(int aTarget, int apTarget)
    {
        this.accountList.get(aTarget).getAdditionalProperties().remove(apTarget);
...
//******MAIN*****************************************************************************************************
    ...
    {
        System.out.println("Houston, we are ready to launch.");
        launch(args);
    }
