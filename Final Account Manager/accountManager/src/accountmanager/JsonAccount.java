...
public class JsonAccount 
{
    ...
    public JsonAccount(String l, String u, String p, String ur, String d, String c, ArrayList<SecurityQuestion> sq, ArrayList<AdditionalProperties> ap)
    {
        label = l;
        username = u;
        password = p;
    ...
    //Same label?
    public boolean hasSameLabel(JsonAccount a)
    {
    ...
    //CompareTo
    public int compareTo(JsonAccount a)
    {//comparing labels
