        ...
        submit.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event)
            {
                ...
                else
                {
                    ...
                    {
                        Logger.getLogger(AddAccount.class.getName()).log(Level.SEVERE, null, ne);
                    }
                    catch(NoSuchPaddingException p)
                    {
                        Logger.getLogger(AddAccount.class.getName()).log(Level.SEVERE, null, p);
                    }
                    catch(InvalidKeyException i)
                    {
                        Logger.getLogger(AddAccount.class.getName()).log(Level.SEVERE, null, i);
                    }
                    catch(IllegalBlockSizeException ib)
                    {
                        Logger.getLogger(AddAccount.class.getName()).log(Level.SEVERE, null, ib);
                    }
                    catch(BadPaddingException bp)
                    {
                        Logger.getLogger(AddAccount.class.getName()).log(Level.SEVERE, null, bp);
                    }
                    writer.print(json);
