 ...
 *Project: Error Key
 * 
 * Purpose: An error page that is displayed when a bad key is entered
 * 
 * -----------------------------------------------------------------------------------
 */
...
public class ErrorKey
{
    ...
    //constructor
    public ErrorKey() //throws IOException
    {
...
//**STAGE**********************************************************************    
    public Scene openScene(Stage stage) 
    {
        ...
        displayText.setText("Error! The master password you entered is incorrect!");
