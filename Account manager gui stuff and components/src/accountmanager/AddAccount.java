        ...
        submit.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            public void handle(ActionEvent event)
            {
                ...
                else
                {
                    ...
                    account.setAccount(labelInput, userNameInput, passWordInput, urlInput, description);
                    
                    //encrypt contents
                    try
                    {
                    Encrypt e = new Encrypt();
                    labelInput = e.encrypt(labelInput,masterPass);
                    userNameInput = e.encrypt(userNameInput,masterPass);
                    passWordInput = e.encrypt(passWordInput,masterPass);
                    urlInput = e.encrypt(urlInput,masterPass);
                    description = e.encrypt(description,masterPass);
                    }
                    ...
                    writer.print("\n");
                    writer.print(labelInput);
                    writer.print("\n");
                    writer.print(userNameInput);
                    writer.print("\n");
                    writer.print(passWordInput);
                    writer.print("\n");
                    writer.print(urlInput);
                    writer.print("\n");
